...
Все ссылки лицензии ссылаются на оригинальный репозиторий, только она является актуальной и достоверной лицензией поекта. Для ознакомление, текущая копия данной лицензии доступна [Здесь](https://github.com/stalker14-project/stalker14-license/blob/master/LICENSE.TXT).
